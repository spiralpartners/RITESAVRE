...
public class NotReviewedComponentController {
	...
	public ArrayList<NotReviewedComponentEntity> execute(MilestoneForm msf){
		logger.info("NotReviewedComponentController.execute");

		TracDao tDao = new TracDao(MyBatisConnectionFactory.getSqlSessionFactory(msf.getProject()));
