 ...
 *
 */
public class DBUtilsLogMongo {
	private static Mongo m;
	private static DB db;
	private static final String dbName = "fluentd";

	// for singleton
	private static DBUtilsLogMongo singleton = new DBUtilsLogMongo();

	public static DBUtilsLogMongo getInstance() {
		return singleton;
	}

	// invisible singleton constructor
	private DBUtilsLogMongo() {
		try {
	...
	public static void convertToDBObject(DBObject dest, Object from){
		try {
			...
			Logger logger = Logger.getLogger(DBUtilsLogMongo.class.getName());
